...
void editorInsertChar(int c) {
  //if the cursor is on the tilde line at the end of the file, 
...
//print tilde's at the top like in VIM
...
void editorRefreshScreen() {
  editorScroll();
  //writing 4 bytes out to the terminal, escape chracter and some other command
